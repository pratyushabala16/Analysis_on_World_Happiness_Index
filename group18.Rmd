...
```{r ,echo = FALSE}
knitr::include_graphics("C:/Users/pratyusha/OneDrive/Pictures/Screenshots/Screenshot (321).png")
```

This is largely due to the wealth difference in these regions. Interestingly, Russia has relatively neutral score.
...
8) World Countries:  <http://tapiquen-sig.jimdo.com.>
